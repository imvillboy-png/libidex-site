    ...
    try {
        ...
        if (path.startsWith('/api/orders')) {
            ...
            if (request.method === 'POST') {
                ...
                await db.prepare(`
                    INSERT INTO orders (id, name, phone, country, product, clickid, utm_campaign, utm_source)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(id, name, phone, country, product, clickid, utm_campaign, utm_source).run();
