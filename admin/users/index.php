...
<head>
    ...
    <title>Admin Users - Libidex Admin</title>
        ...
        <main class="main-content">
            <div class="header">
                ...
                <div class="header-actions">
                    ...
                    <a href="create.php" class="btn btn-sm btn-add">
                        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="create.php" class="btn btn-sm btn-add">Add New User</a>
                </div>
                <div class="card-body">
                    <?php if (empty($users)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($user['id'] == $_SESSION['admin_id']): ?>
                                                    <span class="badge badge-success" style="margin-left: 8px; font-size: 10px;">You</span>
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    ...
                                                    <?php if ($user['id'] != $_SESSION['admin_id']): ?>
                                                        <a href="delete.php?id=<?php echo $user['id']; ?>" class="btn btn-sm btn-delete" 
