...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($email)) {
        ...
        $checkStmt = $pdo->prepare("SELECT id FROM admin_users WHERE (username = ? OR email = ?) AND id != ?");
        ...
        if ($checkStmt->fetch()) {
            ...
            if (empty($error)) {
                $stmt = $pdo->prepare("UPDATE admin_users SET $updateFields WHERE id = ?");
                $params[] = $id;
...
<head>
    ...
    <title>Edit User - Libidex Admin</title>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select id="role" name="role" class="form-control">
                                    ...
                                    <option value="editor" <?php echo ($user['role'] ?? 'admin') === 'editor' ? 'selected' : ''; ?>>Editor</option>
                                </select>
                            </div>
